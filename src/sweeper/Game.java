...
public class Game
{
   private Bomb bomb; //матрица бомб
   private Flag flag; //матрица флагов
   private GameStat state; //состояние игры
    ...
    public Box getBox (Coord coord) //что надо нарисовать в указанном боксе
    {
